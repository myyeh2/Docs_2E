...
#### **Hexp(D, Q, t)稱作系統響應函數(System Response Function，係由本人推導和C#程式語言實作，故暫定為此名稱，尚待您的評論。)，類似訊號與系統所稱的轉移函數(Transfer Function)，本人認爲系統響應函數比轉移函數更實際、更有意義。另d稱爲係數向量，由量測的初始值或是邊界值，求得d(2m x 1)向量值。**
